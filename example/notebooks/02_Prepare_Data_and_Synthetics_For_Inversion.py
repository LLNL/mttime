...
!\rm B*.sac # remove the unfiltered SAC files
# -

# ### Create input file for tdmtpy
...
# +
# Create headers
headers = dict(origin=df["origin"][0],
               longitude=df["lon"][0],
               latitude=df["lat"][0],
...
# Now we can start the next tutorial and take a look at the moment tensor inversion package `tdmtpy`
