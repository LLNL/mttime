...
def plot_waveform_fits(tensor, show, format, nrows=10):
    ...
    for page, group in enumerate(pages):
        f, ax0, ax1 = _new_page(len(group), nrows+1, ncols, tensor.components, annot=annot)
        # Plot beach balls
...
def plot_lune(m, gamma, delta, show, format):
    """
